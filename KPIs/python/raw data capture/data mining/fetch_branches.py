...
def robust_get_page(session, url, params, handle_rate_limit_func, max_retries=20, endpoint="branches"):
        ...
        while local_attempt <= mini_retry_attempts:
            try:
                ...
                if resp.status_code == 200:
                    ...
                    logging.info("[deadbird/%s-etag] 304 => no new branches => skip" % endpoint)
                    return (resp, False)
