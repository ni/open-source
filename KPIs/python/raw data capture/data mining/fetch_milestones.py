...
def robust_get_page(session, url, params, handle_rate_limit_func, max_retries=20, endpoint="milestones"):
        ...
        while local_attempt<=mini_retry_attempts:
            try:
                ...
                if resp.status_code==200:
                    ...
                    logging.info("[deadbird/%s-etag] 304 => no new milestones => skip" % endpoint)
                    return (resp,False)
